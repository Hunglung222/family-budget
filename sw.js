...
const A = [
  ...
  './css/style.css',
  './js/auth.js','./js/db.js',
  './js/inbox.js','./js/chat.js','./js/firebase.js','./js/assistant.js','./js/tw_stocks.js','./js/badges.js','./js/garden.js','./js/pet.js','./js/advisor.js','./js/claude.js',
